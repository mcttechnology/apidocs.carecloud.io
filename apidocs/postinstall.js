...
const defaultHostPrefix = 'https://raw.githubusercontent.com/NetCoreTemplates/razor-pages/main/apidocs/'
const hostFiles = [
    'Markdown.Meta.cs',
    'Markdown.Pages.cs',
...
hostFiles.forEach(toFile => {
    const url = toFile.includes('://')
        ? toFile
        : defaultHostPrefix + toFile
    requests.push(fetchDownload(url, toFile, 5))
})
